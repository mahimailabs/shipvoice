    ...
    <>
      ...
      <div className="pad">
        ...
        <div className="split">
          <Panel
            title="Test call"
            meta="talks to the agent from this browser"
            flush
          >
            <TestCall />
          </Panel>
          ...
          <div style={{ display: "grid", gap: "var(--pad-frame)" }}>
            <Panel title="Identity">
              <KV k="Agent name">
                {agent.agent_name}
                <Owner>
                  AGENT_NAME in agent/.env, the name the worker registers under
                </Owner>
              </KV>
              <KV k="Dispatched as">
                {AGENT_NAME}
                <Owner>
                  VITE_AGENT_NAME in frontend/.env, the name this browser asks
                  for
                </Owner>
              </KV>
              <KV k="Business">
                ...
                <Owner>
                  BUSINESS_NAME in backend/.env, spoken in the greeting
                </Owner>
              </KV>
              <KV k="Prompt" mono>
                {agent.prompt_path}
              ...
              <KV k="State">
                ...
                <Owner>
                  this deployment declares one agent and always runs it
                </Owner>
              </KV>
            </Panel>
            ...
            <Panel title="Providers" meta="the voice stack">
              ...
              <div style={{ marginTop: 10 }}>
                <Ann>
                  Declared in the worker source at agent/src/agent.py, not read
                  back from the running process. Swapping a provider is a code
                  change and a worker restart, not a setting here.
                </Ann>
              </div>
            </Panel>
          </div>
